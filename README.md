...
- **本番環境（固定URL）**: https://baby-diary.pages.dev
- **最新プレビュー**: https://f67f6dda.baby-diary.pages.dev
...
### 2025-11-07 v2.6.0
- ✅ 認証方式をlocalStorageに変更（ブラウザを閉じてもログイン状態維持）
- ✅ 閲覧・投稿ページに認証チェック追加
- ✅ ログアウトボタン追加

### 2025-11-07 v2.5.0
- ✅ 閲覧ページの「既存の記録を編集する」ボタンを削除
- ✅ モーダル内に「削除する」ボタンを追加
- ✅ 削除API実装（記録と画像を完全削除）
- ✅ 削除確認ダイアログ追加
